...
def upgrade() -> None:
    ...
    op.add_column('infrastructure_biodiesel_plants', sa.Column('etl_run_id', sa.Integer(), nullable=True))
    op.add_column('infrastructure_biodiesel_plants', sa.Column('lineage_group_id', sa.Integer(), nullable=True))
    op.create_foreign_key(None, 'infrastructure_biodiesel_plants', 'location_address', ['address_id'], ['id'])
    op.create_foreign_key(None, 'infrastructure_biodiesel_plants', 'etl_run', ['etl_run_id'], ['id'])
    op.drop_column('infrastructure_biodiesel_plants', 'address')
    op.create_foreign_key(None, 'infrastructure_petroleum_pipelines', 'etl_run', ['etl_run_id'], ['id'])
    ...
    op.add_column('infrastructure_biosolids_facilities',
                  sa.Column('etl_run_id', sa.Integer(),
                            sa.ForeignKey('etl_run.id'), nullable=True))
    op.add_column('infrastructure_biosolids_facilities',
