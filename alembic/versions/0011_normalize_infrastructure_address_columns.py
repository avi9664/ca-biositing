...
def downgrade() -> None:
    ...
    op.add_column('infrastructure_biodiesel_plants', sa.Column('address', sa.INTEGER(), autoincrement=False, nullable=True))
    op.drop_constraint(None, 'infrastructure_biodiesel_plants', type_='foreignkey')
