...
def extract(project_root: Optional[str] = None) -> Optional[pd.DataFrame]:
    """
    Extracts raw SAF and renewable diesel plants data from a .csv file on Google Drive.
    ...
    # TODO: Update FILE_NAME to match the actual filename in Google Drive.
    FILE_NAME = "saf_and_renewable_diesel_plants.csv"
    MIME_TYPE = "text/csv"
    ...
    WORKSHEET_NAME = "SAF and Renewable Diesel Plants"
