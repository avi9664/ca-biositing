...
def extract(project_root: Optional[str] = None) -> Optional[pd.DataFrame]:
    """
    Extracts raw livestock anaerobic digesters data from a .csv file on Google Drive.
    ...
    FILE_NAME = "Livestock_Anaerobic_Digesters.csv"
    MIME_TYPE = "text/csv"
    ...
    WORKSHEET_NAME = "Livestock Anaerobic Digesters"
