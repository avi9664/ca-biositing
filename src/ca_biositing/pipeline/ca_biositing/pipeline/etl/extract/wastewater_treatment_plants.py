...
def extract(project_root: Optional[str] = None) -> Optional[pd.DataFrame]:
    """
    Extracts raw wastewater treatment plants data from a .csv file on Google Drive.
    ...
    FILE_NAME = "Wastewater_Treatment_Plants.csv"
    MIME_TYPE = "text/csv"
    ...
    WORKSHEET_NAME = "Wastewater Treatment Plants"
